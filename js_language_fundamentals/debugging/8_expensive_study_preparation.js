 ...
 * but the amount charged upon checkout seems too high. Run 
 * the following code and find out why we are charged 
 * incorrectly.
 */
...
/* ANSWER / EXPLANATION
 * We're overcharged because the guard clause uses || to
 * check if a user doesn't remember to put an amount. Ideally,
 * if no amount is given, amount is set to 1 by default.
 * When the use tries to update the amount of pencils to 0,
 * the program evaluates 0 || 1, which leads to the program
 * assigning 1 to amount, rather than 0, because 0 is a falsy
 * value.
 */
