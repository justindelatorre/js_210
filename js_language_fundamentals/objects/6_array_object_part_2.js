...
/* ANSWER:
 * The user is incorrect. The length property only takes into account
 * elements, and the newly-added name-value pairs don't include the new
 * names in the length calculation. The user will get 10 instead.
 */
