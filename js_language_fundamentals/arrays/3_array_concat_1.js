 ...
 * a new array composed of all values from the first array argument and the
 * second array or value argument. Take note of the following specifications
...
function concat(array1, secondArgument) {
  ...
  if (Array.isArray(secondArgument)) {
    for (let secondIdx = 0; secondIdx < secondArgument.length; secondIdx++) {
      resultArr.push(secondArgument[secondIdx]);
    }
  } else {
