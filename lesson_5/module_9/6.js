 ...
 * handle the scenario that the user inadvertently swaps the positions of the 
 * min and max values or the scenario that the min and max values are equal. You 
 * may assume that the user always provides the min and max values.
 */
...
console.log(randomInteger(4, 10));
